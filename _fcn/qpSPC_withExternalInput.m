function [u_opt,y_opt,problem_status] = qpSPC_withExternalInput(Up,Yp,Uf,Yf,Ep,Ef,...
...
% Coefficient
H       = A_y'*Q_blk*A_y + blkdiag(R_blk,lambda_y*eye(p*Tini));
f       = A_y'*Q_blk*b_y;

% Optimization
[x_opt,fval,exitflag,output,lambda] = quadprog(H,f,[],[],[],[]);
